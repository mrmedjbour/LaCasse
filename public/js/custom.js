...
// /* Start API make  */
    ...
    $("div select#Make").change(function () {
        $apiMake = "https://lacasse.herokuapp.com/api/models/?marque=" + $(this).val();
        ...
        $("div select#ModelePart").load("https://lacasse.herokuapp.com/api/parts/?all");
        //enable Daira disable Commune select
...
//------------------------------------------------------------------- search top bar start here ------------------------------------------------------------
    ...
    $deleteChipTagEvent = function () {
        ...
        if (type == "make") {
            ...
            $("div#TopSearchBarDropContent ul").load("https://lacasse.herokuapp.com/api/models/?allMarque");
            $("div#TopSearchAddChip").empty();
        } else if (type == "modele") {
            $("div#TopSearchBarDropContent").hide(0, function () {
                id = $("div[data-type=make]").data('id');
                $apiMod = "https://lacasse.herokuapp.com/api/models/?marque=" + id;
            ...
            $("div#TopSearchBarDropContent").hide(0, function () {
                $("div#TopSearchBarDropContent ul").empty();
                $("div#TopSearchBarDropContent ul").load("https://lacasse.herokuapp.com/api/parts/?allParts");
            });
            $(this).parent().remove();
            ...
            $("div#TopSearchBarDropContent").hide(0, function () {
                $("div#TopSearchBarDropContent ul").empty();
                $("div#TopSearchBarDropContent ul").load("https://lacasse.herokuapp.com/api/parts/?Years");
            });
