                    ...
                    <div id="PaddAnn">
                        <form id="GoPro" class="p-4">
                            ...
                            <div class="text-center w-100"><i class="far fa-clock fa-8x m-3" style="color: #ff8b02;"></i>
                                <p><span class="text-center d-block font-weight-bold mb-2" style="color: #393939;"><strong>{{__('Your demand is awaiting approval')}}</strong></span>{{__('Please wait 24 hour to 7 days, we will contact you soon')}}
                                    <br>{{__('Thank you for your understanding')}}</p>
                            </div>
                        </form>
                    </div>
                </div>
