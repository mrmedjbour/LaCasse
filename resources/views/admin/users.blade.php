@extends('layouts.app')
@section('title'){{__('Manage users')}}@endsection
@section('content')
    <section>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 dash-info">
                    ...
                    <div class="table-responsive table-borderless" style="font-size: 14px;">
                        ...
                        <div class="modal fade" role="dialog" tabindex="-1" id="StatusUserblockModel">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header py-1 UsersModal">
                                        <h4 class="modal-title font-weight-normal">{{__('Change Status Confirmation')}}</h4>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                                    </div>
                                    <div class="modal-body text-center pb-0 UsersModal">
                                        <i class="fas fa-exclamation-circle fa-5x"></i>
                                        <p class="pt-3">{{__('Are you sure you want to (block/unblock) this user ?')}}</p>
                                    </div>
                                    <div class="modal-footer p-2 px-sm-3">
                                        <form class="d-flex justify-content-between m-0 w-100" id="StatUsForm" method="post">
                                            @csrf
                                            @method('PUT')
                                            <button class="btn btn-secondary shadow-none" type="button" data-dismiss="modal">{{__('No')}}</button>
