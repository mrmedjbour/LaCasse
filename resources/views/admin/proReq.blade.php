                ...
                <div class="col-lg-8 dash-info">
                    <div id="PaddAnn">
                        <form id="GoPro" class="p-4" method="POST" action="{{ route("pro.update", $dem->dem_id) }}">
                            ...
                            <div class="w-100">
                                <h5 class="mb-2">Demand information ( @if($dem->dem_etat == 1)<span class="text-success">confirmed</span>@elseif($dem->dem_etat == 2)<span class="text-danger">rejected</span>@else<span class="text-warning">waiting</span>@endif )</h5>
                                ...
                                <div class="form-group">
                                    <label class="weight500 d-block">trade register document :&nbsp;</label>
                            ...
                            <div class="d-flex justify-content-between flex-wrap">
                                <a class="btn btn-danger shadow-none m-2 px-5 font-weight-bold text-white" id="BtnrejectDemPro" role="button">Reject</a>
