        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-1 offset-lg-4 mx-auto form-div">
                    <div class="row">
                        <div class="col">
                            <p>{{ __('Please enter your email address below. You will receive a link to reset your password.') }}</p>
                        </div>
                    </div>
                    @if (session('status'))
                    ...
                    <hr>
                    <span>{{ __('Don\'t have an account?') }}&nbsp;<a href="{{ route('register') }}">{{ __('Create an Account') }}<br></a></span></div>
            </div>
        </div>
    </section>
@endsection
