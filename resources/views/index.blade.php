            ...
            <div id="searchBox">
                ...
                <form class="d-lg-none input-group-addon" id="md-form">
                    <div class="form-group" style="margin-bottom: 0px;">
                        <select class="form-control form-control-lg" autofocus="" required="">
                        ...
                        <select class="form-control form-control-lg" autofocus="" required="" readonly="" disabled="">
                            <option value="Cleo" selected="">Cleo</option>
                            <option value="BMW">BMW</option>
                            <option value="Peojeut">Peojeut</option>
                        ...
                        <select class="form-control form-control-lg" autofocus="" required="" readonly="" disabled="">
                            ...
                            <option value="BMW">BMW</option>
                            <option value="Peojeut">Peojeut</option>
                            <option value="" selected="" disabled="disabled" hidden="hidden">Select Year</option>
                        </select>
                        <select class="form-control form-control-lg" autofocus="" required="" readonly="" disabled="">
                            <option value="Cleo" selected="">Cleo</option>
                            <option value="BMW">BMW</option>
                        ...
                        <button class="btn btn-success btn-lg input-group-addon" type="submit"><strong>Find
                                part&nbsp;</strong><i class="fas fa-search fa-lg"></i>
                        </button>
                    </div>
                </form>
            </div>
