        ...
        <div class="container dashboard">
            <div class="row">
                ...
                <div class="col-lg-8 dash-info">
                    ...
                    @endif
                    <div class="text-center text-sm-right"><a class="btn btn-success btn-sm shadow-none m-2" role="button" href="{{ route('role.create') }}"><i class="fa fa-user-plus mr-1"></i>Add Role</a>
                    </div>
                        ...
                        <table class="table table-striped table-bordered table-sm">
                            ...
                            @foreach($users as $user)
                                <tr>
                                    ...
                                    <td class="text-center">@if ($user->role_id == 3) Seller @elseif($user->role_id == 4) Buyer @endif</td>
