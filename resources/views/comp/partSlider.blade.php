...
<div id="part-carousel-1" class="carousel slide PSlider" data-ride="carousel" data-interval="9000">
    <div class="carousel-inner" role="listbox">
        ...
        @else
            <div class="carousel-item active">
                <img class="w-100 d-block" src="{{ asset('img/car.svg') }}" alt="Slide Image">
            </div>
        @endif
    ...
    <ol class="d-flex d-sm-none carousel-indicators point">
        @if ($ads->images->count() > 0)
            ...
            @endforeach
        @else
            <li class="active" data-slide-to="0" data-target="#part-carousel-1">Item</li>
        @endif
    </ol>
    <ol class="d-none d-sm-flex justify-content-start carousel-indicators carousel-img">
        @if ($ads->images->count() > 0)
            ...
            @endforeach
        @else
            <li class="active" data-slide-to="0" data-target="#part-carousel-1" style="background-image:url('{{ asset('img/car.svg') }}');"></li>
        @endif
    </ol>
</div>