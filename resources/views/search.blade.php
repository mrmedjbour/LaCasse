                ...
                <div class="col-12 col-md-8 order-2 order-md-1" id="content">
                    @if($result->count() == 0)
                        <div class="text-center py-4">
                            ...
                            <h3 class="text-black-50">No Results</h3>
                            <span class="font-weight-bold">Sorry, We couldn't find that part try again later</span>
                        </div>
                    @endif
                            ...
                            <form class="form-inline" method="get">
                                ...
                                <div class="form-group d-flex justify-content-around align-items-center sortByG">
                                    ...
                                    <select class="form-control form-control-sm widthAuto" id="sortBy" name="sortBy">
                                        ...
                                        <option value="asc" @if ($request->sortBy == "asc") selected @endif>Date Asc</option>
                                    </select>
                                </div>
                            </form>
                        </div>
