        ...
        <div class="row">
            ...
            <div class="col-4 col-sm-4 col-md-5 col-xl-4 align-items-center" style="height: 30px;">
                ...
                <div class="dropdown float-right">
                    <a class="btn btn-primary btn-sm dropdown-toggle" data-toggle="dropdown" aria-expanded="false" role="button" style="font-size: 14px;background-color: #004876;border: none;border-radius: 0;padding: 4px 15px;" href="#">English</a>
                    <div class="dropdown-menu dropdown-menu-right" role="menu" style="font-size: 14px;">
                        <a class="dropdown-item" role="presentation" href="#" style="font-size: 15px;">العربية</a>
        ...
        <div class="row d-flex justify-content-between align-items-center">
            ...
            <div class="col-4 col-sm-auto col-md-3 col-lg-5 col-xl-5 d-flex justify-content-end align-items-center justify-content-md-end" style="color: #ffffff;font-family: Montserrat, sans-serif;">
                <div class="d-flex align-items-center">
                    <a class="d-inline-flex align-items-center pcassedir" href="{{route('directory')}}" style="font-size: 16px;margin-right: 20px;">
                        <i class="fas fa-map-marked-alt fa-lg" style="color: #58ba25;margin-right: 4px;"></i>
                        <div class="hideon-sm-log">Casse Directory</div>
                    </a>
                    <a id="notfMsg" class="fas fa-envelope" href="#">
										<span class="d-flex justify-content-center align-items-center fa fa-circle">
											<span class="num">7</span>
										</span>
                    </a>
                    <div class="dropdown">
                        <a class="btn dropdown-toggle shadow-none" data-toggle="dropdown" aria-expanded="false" role="button" href="#" style="padding: 0px;color: #fff;">&nbsp;
                            <img src="{{ asset('img/profile-img.jpg') }}" style="border-radius: 50%;width: 40px;">
                        </a>
                        <div class="dropdown-menu dropdown-menu-right dropdownProfile" role="menu">
                            ...
                            <div class="d-flex justify-content-between foot">
                                <a class="btn btn-light btn-sm" role="button" href="#">
                                    <i class="fas fa-cog"></i>Profile
                                </a>
                                <a class="btn btn-dark btn-sm shadow-none" role="button" href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
    ...
    <div class="d-lg-none collapse navbar-collapse" id="HeadSearch" style="padding: 2em;">
        <form>
            ...
            <div class="form-group d-flex justify-content-between align-items-center">
                <button class="btn" type="reset" style="background-color: #656565;color: rgb(255,255,255);">
